...
bool GPTimer::init(uint32_t resolution_hz, uint64_t alarm_count) {
    ...
    alarm_config = {.alarm_count = alarm_count, .reload_count = 0, .flags = {.auto_reload_on_alarm = true}};
...
IRAM_ATTR bool GPTimer::internalCallback(gptimer_handle_t timer, const gptimer_alarm_event_data_t *edata, void *user_ctx) {
